...
# 设置正确的串口参数------------------------
ser_port = "COM3"     #此处需要替换为对应使用的串口号，windows系统写成COMx，若是linux则要根据所用系统进行调整如写成/dev/ttyUSBx或/dev/ttySx
...
def read_data():
    ...
    #time.sleep(0.2)
    #Cmd_PackAndTx([0x51,0xAA,0xBB], 3) # 用总圈数代替欧拉角传输 并清零圈数 0x51
    #Cmd_PackAndTx([0x51,0x00,0x00], 3) # 输出欧拉角 0x51
